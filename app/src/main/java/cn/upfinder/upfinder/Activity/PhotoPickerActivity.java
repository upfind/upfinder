...
import cn.upfinder.upfinder.Adapter.FloderAdapter;
import cn.upfinder.upfinder.Adapter.PhotoAdapter;
import cn.upfinder.upfinder.Model.Bean.Photo;
import cn.upfinder.upfinder.Model.Bean.PhotoFloder;
import cn.upfinder.upfinder.R;
import cn.upfinder.upfinder.Utils.FileUtil;
import cn.upfinder.upfinder.Utils.PhotoUtils;
...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    private void getPhotosSuccess() {
        ...
        mPhotoNumTV.setText(StringUtil.formatResourceString(getApplicationContext(),
    ...
    public void onPhotoClick() {
        ...
        if(list != null && list.size()>0) {
            ...
            mCommitBtn.setText(StringUtil.formatResourceString(getApplicationContext(),
    ...
    private void initAnimation(View dimLayout) {
         ...
         */
        int height = ScreenUtils.getScreenH(this) - 3*actionBarHeight;
    ...
    private void showCamera() {
        ...
        if(cameraIntent.resolveActivity(getPackageManager()) != null){
            ...
            Toast.makeText(getApplicationContext(),
                    R.string.no_camera, Toast.LENGTH_SHORT).show();
        }
